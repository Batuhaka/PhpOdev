...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 23 May 2023, 21:30:29
...
--
ALTER TABLE `adverts`
  MODIFY `advert_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
-- Tablo kısıtlamaları `adverts`
--
ALTER TABLE `adverts`
  ADD CONSTRAINT `adverts_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);
COMMIT;
